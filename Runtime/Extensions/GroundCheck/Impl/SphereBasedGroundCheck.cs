...
namespace Depra.Pawn.Runtime.Extensions.GroundCheck.Impl
{
    public class SphereBasedGroundCheck : GroundChecker
    {
        ...
        [Tooltip("Offset for the ground spherecast. Will need tweaking based on character collider.")]
        [SerializeField] private Vector3 _sphereCastOffset;

        [Tooltip("Size of ground spherecast. Will need tweaking based on character collider.")] 
